...
function processData(sheetData) {
    ...
    sheetData.forEach(row => {
        ...
        if (type.includes("women daily collection")) {
            monthlyData[yearMonth].totalCollection += amount;
        } else if (type.includes("women rent")) {
            monthlyData[yearMonth].rent += amount;
        } else if (type.includes("women current")) {
            monthlyData[yearMonth].current += amount;
        } else if (type.includes("women investment")) {
        ...
        monthlyData[yearMonth].profit =
            ...
            (monthlyData[yearMonth].rent + monthlyData[yearMonth].current + monthlyData[yearMonth].investment);
        ...
        if (type.includes("women rent")) yearlyTotal[year].rent += amount;
        if (type.includes("women current")) yearlyTotal[year].current += amount;
        if (type.includes("women investment")) yearlyTotal[year].investment += amount;

        yearlyTotal[year].profit =
            yearlyTotal[year].totalCollection -
            (yearlyTotal[year].rent + yearlyTotal[year].current + yearlyTotal[year].investment);
    });
        ...
        let tableHTML = `
            <div class="year-section">
                ...
                <table>
                    ...
                    <tr><td>Women Rent:</td><td>${data.rent}</td></tr>
                    <tr><td>Women Current:</td><td>${data.current}</td></tr>
                    <tr><td>Women Investment:</td><td>${data.investment}</td></tr>
