...
function processData(sheetData) {
    ...
    sheetData.forEach(row => {
        ...
        if (type.includes("gold rent")) yearlyTotal[year].rent += amount;
        if (type.includes("gold current")) yearlyTotal[year].current += amount;
        if (type.includes("gold investment")) yearlyTotal[year].investment += amount;
        if (type.includes("gold salary")) yearlyTotal[year].salary += amount; // Added Salary
        ...
        let tableHTML = `
            <div class="year-section">
                ...
                <table>
                    ...
                    <tr><td>Gold Rent:</td><td>${data.rent}</td></tr>
                    <tr><td>Gold Current:</td><td>${data.current}</td></tr>
                    <tr><td>Gold Investment:</td><td>${data.investment}</td></tr>
                    <tr><td>Gold Salary:</td><td>${data.salary}</td></tr>
